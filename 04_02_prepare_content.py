...
def group_entries(entry_ids, file_names, index_of_interest, group_window_size):
    ...
    # If it needs no grouping, return an array with just its index (will be hanlded as in get_surrounding_sentences) 
